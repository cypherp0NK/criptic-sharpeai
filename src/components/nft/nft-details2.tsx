  ...
  return (
    <div className='w-full bg-txnLightMagenta rounded-lg'>
      <div className="w-full p-4">
        ...
        <h3 className='font-medium'>FRAX</h3>
        <div className="flex flex-row gap-2">
          <a
          target="_blank"
          rel="noopener noreferrer"
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://polygonscan.com/token/0x45c32fA6DF82ead1e2EF74d17b76547EDdFaFF89"
          className='p-1 mt-1.5 inline-flex items-center text-xs -tracking-wider rounded-md tracking-tighter bg-txnLightMagenta2'>
          Token Contract<ArrowLinkIcon className="h-3 w-3 ltr:ml-2 rtl:mr-2" />
          </a>
        </div>
      ...
      <div className='w-full text-xs text-gray-600 dark:text-gray-400 bg-txnLightMagenta2 p-4 rounded-b-lg'>
      The Frax Protocol is the first stablecoin system based on a fractional algorithm. FRAX is a stablecoin that is partially backed by collateral and partially stabilized algorithmically.
      </div>
    </div>
  )
}
    ...
    >
      <div className="-mx-4 border-t-2 border-gray-900 px-4 pt-4 pb-5 dark:border-gray-700 sm:-mx-6 sm:px-6 md:mx-2 md:px-0 md:pt-5 lg:pt-6 lg:pb-7">
        {isAuction && (
          ...
          <AnchorLink href="https://polygonscan.com/address/0xFD3B52fDF0CE5E0919400Fc90C2C5183BE517eE8" className="inline-flex items-center -tracking-wider">
          ...
          <AnchorLink href="https://polygonscan.com/address/0x424F6fb57261842fc813463eB0B16d9fF7779127" className="inline-flex items-center -tracking-wider">
            <div className="text-sm leading-6 -tracking-wider text-white-600 dark:black-gray-400">
                Strategy Address
            </div>
            <ArrowLinkIcon className="h-3 w-3 ltr:ml-2 rtl:mr-2" />
        ...
        <div className="relative flex w-full flex-grow flex-col justify-between ltr:md:ml-auto ltr:md:pl-8 rtl:md:mr-auto rtl:md:pr-8 lg:min-h-[calc(100vh-96px)] lg:w-[460px] ltr:lg:pl-12 rtl:lg:pr-12 xl:w-[592px] ltr:xl:pl-20 rtl:xl:pr-20">
          <div className="block">
            <div className="block">
              ...
              <AnchorLink
                href="https://polygonscan.com/address/0xFD3B52fDF0CE5E0919400Fc90C2C5183BE517eE8"
                ...
                <TabPanel className="focus:outline-none">
                  <div className="space-y-6">
                    <div className="block">
                      ...
                      USDC-FRAX VAULT AUTOMATICALLY MANAGES LIQUIDITY ON UNISWAP V3. IT CONCENTRATES ITS LIQUIDITY TO EARN HIGHER YIELDS AND AUTOMATICALLY ADJUSTS ITS RANGE ORDERS AS THE UNDERLYING PRICE MOVES IN ORDER TO CONTINUE CAPTURING FEES.
                      </h3>
