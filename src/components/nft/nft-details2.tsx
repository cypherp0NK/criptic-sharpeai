                ...
                <TabPanel className="focus:outline-none">
                  <div className="space-y-6">
                    <div className="block">
                      ...
                      USDC-FRAX vault automatically manages on uniswap V3. It concentrates its liquidity to earn higher yields and automatically adjusts its range orders as the underlying price moves in order to continue capturing fees.
                      </h3>
