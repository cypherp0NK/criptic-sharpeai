    ...
    >
      <div className="-mx-4 border-t-2 border-gray-900 px-4 pt-4 pb-5 dark:border-gray-700 sm:-mx-6 sm:px-6 md:mx-2 md:px-0 md:pt-5 lg:pt-6 lg:pb-7">
        {isAuction && (
          ...
          <AnchorLink href="https://polygonscan.com/address/0xbe8db36731ff8072b1c58d32aacf8d1bcedec77b" className="inline-flex items-center -tracking-wider">
                ...
                <TabPanel className="focus:outline-none">
                  <div className="space-y-6">
                    <div className="block">
                      ...
                      USDC-USDT VAULT AUTOMATICALLY MANAGES LIQUIDITY ON UNISWAP V3. IT CONCENTRATES ITS LIQUIDITY TO EARN HIGHER YIELDS AND AUTOMATICALLY ADJUSTS ITS RANGE ORDERS AS THE UNDERLYING PRICE MOVES IN ORDER TO CONTINUE CAPTURING FEES.
                      </h3>
